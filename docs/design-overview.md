...
raw, cleaned, adjusted, melody-only, chord-only, combined 비교 산출물은 manual/debug artifact로 유지한다.  
단, midiPath 자체는 final melody와 chord/accompaniment가 함께 들어간 main product output이다.
